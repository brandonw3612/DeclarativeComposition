...
public class RectangleGeometryTest() : TestBase("ProviderTests/RectangleGeometryTest")
{
    protected override void VerifyAst(RootNode root)
    {
        ...
        Assert.Equal("RectangleGeometry", firstChild.Type);
        ...
        Assert.Equal("RectangleGeometry", (firstChild.Properties[0].Value as StringLiteralNode)?.Content);
        ...
        Assert.Equal("size", firstChild.Properties[5].Name);
