...
public class LineGeometryTest() : TestBase("ProviderTests/LineGeometryTest")
{
    protected override void VerifyAst(RootNode root)
    {
        ...
        Assert.Equal("LineGeometry", (firstChild.Properties[0].Value as StringLiteralNode)?.Content);
        ...
        Assert.Equal("100", (firstChild.Properties[4].Value as StringLiteralNode)?.Content);
