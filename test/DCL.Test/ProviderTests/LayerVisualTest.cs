...
public class LayerVisualTest() : TestBase("ProviderTests/LayerVisualTest")
{
    protected override void VerifyAst(RootNode root)
    {
        ...
        Assert.Equal("LayerVisual", firstChild.Type);
        ...
        Assert.Equal("LayerVisual", (firstChild.Properties[0].Value as StringLiteralNode)?.Content);
