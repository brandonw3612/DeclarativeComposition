...
namespace DCL.Test.ProviderTests {
    partial class LayerVisualTest {
        private Microsoft.UI.Composition.Compositor _compositor;

        public LayerVisualTest(Microsoft.UI.Composition.Compositor compositor) {
            _compositor = compositor;
            var obj1 = _compositor.CreateLayerVisual();
            obj1.Comment = "LayerVisual";
