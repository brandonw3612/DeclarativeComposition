...
public class ShapeVisualTest() : TestBase("ProviderTests/ShapeVisualTest")
{
    protected override void VerifyAst(RootNode root)
    {
        ...
        Assert.Equal("ShapeVisual", firstChild.Type);
        ...
        Assert.Equal("ShapeVisual", (firstChild.Properties[0].Value as StringLiteralNode)?.Content);
